...
class CartService {
  static const String _baseUrl =
      'https://api-sable-eta.vercel.app/api/carts';
  ...
  static Future<List<dynamic>> getOrderHistory() async {
    try {
      ...
      final possibleUrls = [
        'https://api-sable-eta.vercel.app/api/orders?clientId=$clientId', // query parameter con filtro
        'https://api-sable-eta.vercel.app/api/client/$clientId/orders',
        'https://api-sable-eta.vercel.app/api/clients/$clientId/orders',
        'https://api-sable-eta.vercel.app/api/order/$clientId', // singular
        'https://api-sable-eta.vercel.app/api/orders/$clientId', // original
      ];
  ...
  static Future<Map<String, dynamic>> getOrderDetails(int orderId) async {
    try {
      ...
      final detailsResponse = await http.get(
        Uri.parse('https://api-sable-eta.vercel.app/api/orders/$orderId'),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
        },
      ...
      final taxResponse = await http.get(
        Uri.parse('https://api-sable-eta.vercel.app/api/orders?clientId=$clientId/$orderId'),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
        },
