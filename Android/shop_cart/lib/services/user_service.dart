...
class UserService {
  static const String baseUrl = 'https://api-sable-eta.vercel.app/api/user';
        ...
        if (data['token'] != null) {
          ...
          if (data['token'] is String) {
            ...
            try {
              ...
              throw Exception('Error al decodificar el token: $jwtError');
            }
  ...
  static Future<Map<String, dynamic>> register({
    ...
    final response = await http.post(
      Uri.parse('https://api-sable-eta.vercel.app/api/clients'),
      headers: {'Content-Type': 'application/json'},
      body: jsonEncode({
        'cedula': cedula,
        'email': email,
