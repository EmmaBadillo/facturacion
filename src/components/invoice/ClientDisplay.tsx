    ...
    <div className="client-display">
      <div className="client-header">
        <div className="client-title">
          <User className="title-icon" size={18} /> {/* Tamaño de icono ajustado */}
          <h3>Cliente Seleccionado</h3>
        </div>
        <button className="edit-client-btn" onClick={onEdit} title="Cambiar cliente">
          <Edit3 size={14} /> {/* Tamaño de icono ajustado */}
          Cambiar
        </button>
      </div>
      <div className="client-details-grid">
        <div className="detail-card">
          <div className="detail-header">
            <User className="detail-icon" size={14} /> {/* Tamaño de icono ajustado */}
        ...
        <div className="detail-card">
          <div className="detail-header">
            <Mail className="detail-icon" size={14} /> {/* Tamaño de icono ajustado */}
        ...
        <div className="detail-card">
          <div className="detail-header">
            <Phone className="detail-icon" size={14} /> {/* Tamaño de icono ajustado */}
        ...
        <div className="detail-card">
          <div className="detail-header">
            <CreditCard className="detail-icon" size={14} /> {/* Tamaño de icono ajustado */}
        ...
        <div className="detail-card address-card">
          <div className="detail-header">
            <MapPin className="detail-icon" size={14} /> {/* Tamaño de icono ajustado */}
