...
import { Home, Package, History, LogOut, Menu, X, UserCircle } from "lucide-react"
      ...
      <nav className="app-navbar">
        <div className="navbar-container">
          ...
          <div className="navbar-brand">
            <UserCircle size={24} className="brand-icon" />
          ...
          <div className="navbar-right">
            <span className="user-greeting">Bienvenido, {user?.nombre || "Cliente"}</span>
